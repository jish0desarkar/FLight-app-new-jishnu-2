...
class AeroplanesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aeroplane" do
    assert_difference('Aeroplane.count') do
      post aeroplanes_url, params: { aeroplane: { model: @aeroplane.model, number_of_seats: @aeroplane.number_of_seats } }
    end
  ...
  test "should update aeroplane" do
    patch aeroplane_url(@aeroplane), params: { aeroplane: { model: @aeroplane.model, number_of_seats: @aeroplane.number_of_seats } }
